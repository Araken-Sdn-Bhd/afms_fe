                      ...
                      @submit.prevent="onUpdate">
                        ...
                        <div class="form-foter mt-3">
                          ...
                          <div class="ml-auto" id="hidebutton" ref="hidebutton">
                            <button type="submit" @click="onDelete()" class="btn btn-danger btn-text"> <i class="fa fa-trash"></i> delete</button>
                            <button type="submit" class="btn btn-success btn-text"> <i class="fa fa-save"></i> update</button>
                          </div>
                        </div>
                      </form>
                    </div>
